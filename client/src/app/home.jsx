              ...
              <div className="relative border rounded-md  ">
                <p className="max-w-[500px] text-base lg:text-lg  font-semibold  p-8 pb-0 flex flex-col gap-4">
                  <span>
                    ...
                    in a frustrating situation whenever I visited a manga store.
                    I would need to check which volumes I already owned, and it
                  ...
                  <span>
                    ...
                    easy-to-use, organized system to manage my collection and
                    make sure I wasn't buying duplicates.
                  </span>
                  <span>
                    ...
                    collection organized in just a few clicks. No more clutter,
                    no more stress—just a smooth, simple way to manage your
                    manga collection.
                  </span>
                </p>
        ...
        <section className="border border-dashed p-0  m-0 border-b-0 border-x-0">
          <div className="container-wrapper flex  items-center">
            <div className="flex flex-col gap-2 py-10 w-full ">
              ...
              <p className="text-base lg:text-lg text-muted-foreground font-semibold max-w-[600px]  mt-6">
                Our beautifully designed UI ensures that managing your
                collection is both fast and intuitive.
              </p>
              <OtherFeaturesCard />
            </div>
          </div>
